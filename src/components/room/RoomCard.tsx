...
import { AirVent, Bath, Bed, BedDouble, Castle, Home, Loader2, MountainSnow, Pencil, Ship, Trash, Trees, Tv, Users, UtensilsCrossed, VolumeX, Wand2, Wifi } from "lucide-react";
...
const RoomCard = ({ hotel, room, bookings = [] }: Props) => {
                        ...
                        : <div className="flex w-full justify-between">
                            ...
                            <Dialog open={open} onOpenChange={setOpen} >
                                ...
                                <DialogContent className="max-w-[900px] w-[90%]">
                                    ...
                                    <AddRoomForm handleDialogOpen={handleDialogOpen} room={room} hotel={hotel} />
                                </DialogContent>
                            </Dialog>
                        </div>}
                </CardFooter>}
